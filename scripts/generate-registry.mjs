...
const registry = {
  ...
  items: [
    ...
    ui(
      "calendar",
      "Calendar",
      "Inline day/month/year grid — single or range ISO dates.",
      "packages/ui/src/atoms/calendar.tsx",
    ),
    ui(
      "date-picker",
      "Date Picker",
      "Single or range ISO dates — portal panel over Calendar.",
      "packages/ui/src/atoms/date-picker.tsx",
      { extra: [PRESENCE, FLOATING, FLOATING_HOOK], deps: ["calendar"] },
    ),
    ui(
      "time-picker",
      "Time Picker",
      "HH:mm trigger + panel with TimeInput and presets.",
      "packages/ui/src/atoms/time-picker.tsx",
      { extra: [PRESENCE, FLOATING, FLOATING_HOOK], deps: ["time-input"] },
    ),
